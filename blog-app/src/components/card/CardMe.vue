<template>
  <el-card>
    <h1 class="me-author-name">团队介绍</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;成都大学-键盘女侠团队</span>
    ...
    <p><i class="el-icon-user user-team"> &nbsp;陈超</i></p>
    <p><i class="el-icon-user user-team"> &nbsp;黄涛</i></p>
    <p><i class="el-icon-user user-team"> &nbsp;陈红梅</i></p>
    <p><i class="el-icon-user user-team"> &nbsp;马寅孟</i></p>
    <p><i class="el-icon-user user-team"> &nbsp;徐傲</i></p>
    <p><i class="el-icon-user user-team"> &nbsp;刘雷</i></p>
  </el-card>
